...
- next_action: upload one compatible task file to the public bucket, verify its direct resolve URL returns HTTP 200, then rerun the workflow using that URL
